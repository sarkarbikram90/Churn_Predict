...
Model is trained locally on the Telco Customer Churn dataset

Experiments and metrics are tracked using MLflow

The trained model is exported as a serialized artifact

Streamlit loads the exported model and serves predictions via a web UI
